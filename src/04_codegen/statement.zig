...
pub fn emit_statement(ctx: *CodegenContext, node: *const Statement, block_ctx: *const BlockContext) void {
    switch (node.*) {
        .expression => |expression| emit_expression(ctx, expression, block_ctx),
        .variableBinding => {
