...
pub fn build(b: *std.Build) void {
    ...
    // circular dependency on semantic: syntax needs to know
    // about the semantic visitors, and semantic needs to know
    // about the syntax AST
    syntax_module.addImport("semantic", semantic_module);
    //
